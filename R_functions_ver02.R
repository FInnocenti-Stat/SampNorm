...
Tau_AP_CI_PR<-function(alpha,PR0,N,design=c("Optimal"),k,model=~Age, min_age=20, max_age=80, g_age, Age_levels=c("Uniform"), granularity=100, q_sex, min_edu, max_edu, Edu_levels, g_edu, q_edu){ 
